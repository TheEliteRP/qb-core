...
QBConfig.Player.ThirstRate = 3.5 -- Rate at which thirst goes down.
...
QBConfig.Server.Discord = "https://discord.gg/theeliterp" -- Discord invite link
QBConfig.Server.CheckDuplicateLicense = true -- Check for duplicate rockstar license on join
QBConfig.Server.Permissions = {'god', 'admin',} -- Add as many groups as you want here after creating them in your server.cfg
